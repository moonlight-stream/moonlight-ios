...
- (void)setDPadCenter {
    ...
    OSCProfile *oscProfile = [profilesManager selectedOSCProfile]; //returns the currently selected OSCProfile
...
- (void)layoutOSC {
    ...
    OSCProfile *oscProfile = [profilesManager selectedOSCProfile];
