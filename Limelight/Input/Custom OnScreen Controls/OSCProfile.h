...
/**
 ...
 Additionally the 'OSCProfile' object adopts encoding protocols so that we can encode the object before saving it to NSUserDefaults. By saving this object to NSUserDefaults we allow the user to save and load their custom on screen controller button layouts between app launches
 */
